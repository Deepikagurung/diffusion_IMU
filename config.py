...
class paths:
    ...
    raw_amass = Path(r"C:\deepika\2_mobileposer\MobilePoser\mobileposer\data\raw\AMASS")           # TODO: replace with your path
    raw_dip = Path(r"C:\deepika\2_mobileposer\MobilePoser\mobileposer\data\raw\DIP_IMU")           # TODO: replace with your path
    raw_imuposer = Path(r"C:\deepika\2.mobileposer\MobilePoser\mobileposer\data\raw\IMUPoser")     # TODO: replace with your path
...
class paths_:
    ...
    raw_amass = Path(r"C:\deepika\2_mobileposer\MobilePoser\mobileposer\data\raw\AMASS")           # TODO: replace with your path
    raw_dip = Path(r"C:\deepika\2_mobileposer\MobilePoser\mobileposer\data\raw\DIP_IMU")           # TODO: replace with your path
    raw_imuposer = Path(r"C:\deepika\2_mobileposer\MobilePoser\mobileposer\data\raw\IMUPoser")     # TODO: replace with your path
    eval_dir = root_dir / "data/processed_datasets/eval"
    processed_datasets = root_dir / "data/processed_datasets_v2"
    raw_totalcapture_official = root_dir / "data/raw/TotalCapture/raw"  # TODO: replace with your path
    calibrated_totalcapture = root_dir / "data/raw/TotalCapture/IMU"  # TODO: replace with your path
